...
add wave -noupdate /controller_fpga2_tb/uut/DatReqBuff_Count
add wave -noupdate /controller_fpga2_tb/uut/DatReqBuff_Empty
add wave -noupdate /controller_fpga2_tb/uut/DatReqBuff_Out
add wave -noupdate /controller_fpga2_tb/uut/DatReqBuff_rdreq
...
WaveRestoreCursors {{Cursor 1} {9745145 ps} 0}
...
update
WaveRestoreZoom {9596314 ps} {9963139 ps}
